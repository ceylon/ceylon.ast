...
shared abstract class Node()
        of ExpressionIsh | Statement | Declaration | CompilationUnit | Annotation | Annotations | Parameter | Body | TypeParameter | TypeParameters | CaseTypes | SatisfiedTypes | TypeConstraint | PackageDescriptor | ModuleImport | ModuleBody | ModuleDescriptor | Alias | ImportWildcard | ImportElement | ImportElements
        extends Object() {
