...
shared object binaryOperation satisfies AbstractTest<BinaryOperation,JBinaryOperatorExpression> {
    ...
    tests = [arithmeticOperation, setOperation, scaleOperation, spanOperation, measureOperation, entryOperation, inOperation, comparisonOperation, compareOperation, equalityOperation, logicalOperation];
}
