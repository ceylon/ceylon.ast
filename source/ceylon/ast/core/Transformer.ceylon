...
shared interface Transformer<out Result> {
    ...
    shared formal Result transformModuleSpecifier(ModuleSpecifier that);
    ...
    shared formal Result transformValueConstructorDefinition(ValueConstructorDefinition that);
