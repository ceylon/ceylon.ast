...
shared abstract class Node()
        of ExpressionIsh | Statement | Declaration | Annotation | Annotations | Parameter | Body | TypeParameter | TypeParameters | CaseTypes | SatisfiedTypes | TypeConstraint | PackageDescriptor | ModuleImport | ModuleBody | ModuleDescriptor | Alias | ImportWildcard | ImportElement | ImportElements | Import | AnyCompilationUnit | Condition | ConditionList | IfClause | ElseClause
        extends Object() {
